...
var settings_default = {
	...
	"kikotools.custom_colors.auto_shade": {
		"name": "🫶 自定义颜色：标题自动明暗调整",
		"tooltip": "自动对标题颜色应用明暗调整，以获得更好的对比度。"
	},
	"kikotools.custom_colors.enabled": {
		"name": "🫶 自定义颜色：启用",
		"tooltip": "在节点右键菜单中启用自定义颜色选择项（完整/标题/背景）。"
	},
	"kikotools.custom_colors.show_bg": {
		"name": "🫶 自定义颜色：显示背景颜色选项",
		"tooltip": "显示仅修改背景颜色的选项。"
	},
	"kikotools.custom_colors.show_full": {
		"name": "🫶 自定义颜色：显示完整颜色选项",
		"tooltip": "显示同时修改标题和背景颜色的选项。"
	},
	"kikotools.custom_colors.show_title": {
		"name": "🫶 自定义颜色：显示标题颜色选项",
		"tooltip": "显示仅修改标题颜色的选项。"
	},
	"kikotools.embeddingAutocomplete": {
		"name": "🫶 Embedding 自动补全配置",
		"tooltip": "打开并配置自动补全设置。"
	},
	"kikotools.follow_execution.auto_start": {
		"name": "🫶 跟随执行：自动开始",
		"tooltip": "在工作流开始执行时自动开始跟随。"
	},
	"kikotools.follow_execution.enabled": {
		"name": "🫶 跟随执行：启用",
		"tooltip": "在画布右键菜单中启用“跟随执行”功能。"
	},
	"kikotools.follow_execution.show_goto_node": {
		"name": "🫶 跟随执行：显示“转到节点”菜单",
		"tooltip": "在画布菜单中显示“转到节点”子菜单。"
	},
	"kikotools.workflow_timer.color": {
		"name": "🫶 工作流计时器：颜色",
		"tooltip": "设置计时器在非运行状态下的显示颜色。"
	},
	"kikotools.workflow_timer.glow": {
		"name": "🫶 工作流计时器：启用发光效果",
		"tooltip": "为计时器启用脉冲发光效果。"
	},
	pysssss_SnapToGrid
};
//#endregion
...
//# sourceMappingURL=settings-BP76y3Ds.js.map