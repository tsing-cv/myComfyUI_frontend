const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./i18n-Bm7WRk8g.js","./vendor-primevue-Dnp2bJ8y.js","./rolldown-runtime-DBfy44LZ.js","./vendor-vue-core-Ba0aGEmU.js","./i18n-1Rh80DIx.js","./vendor-i18n-CQIJzQYM.js"])))=>i.map(i=>d[i]);
...
import { Z as collectAllNodes, ft as mapAllNodes, mt as isAbortError, r as api } from "./api-DZnjKRFN.js";
...
import { r as useSystemStatsStore, t as useCopyToClipboard } from "./useCopyToClipboard-MPqv8vkx.js";
...
var useBootstrapStore = defineStore("bootstrap", () => {
	...
	const { isReady: isI18nReady, error: i18nError, execute: loadI18n } = useAsyncState(async () => {
		const { mergeCustomNodesI18n } = await __vitePreload(async () => {
			const { mergeCustomNodesI18n } = await import("./i18n-Bm7WRk8g.js");
...
//# sourceMappingURL=useConflictDetection-ZavzbBWu.js.map