...
var cloudSurvey_steps_familiarity = "Насколько вы знакомы с ComfyUI?";
var cloudSurvey_steps_industry = "В какой отрасли вы работаете?";
var cloudSurvey_steps_making = "Что вы планируете создавать?";
var cloudSurvey_steps_purpose = "Для чего вы в основном будете использовать ComfyUI?";
...
var comfyHubProfile = {
	...
	"createProfileTitle": "Создайте профиль Comfy Hub",
	...
	"introSubtitle": "Чтобы поделиться своим workflow в ComfyHub, сначала создайте профиль.",
	"introTitle": "Публикация в ComfyHub",
	"modalTitle": "Создайте свой профиль в ComfyHub",
	"nameLabel": "Ваше имя",
...
var comfyHubPublish = {
	...
	"createProfileToPublish": "Создайте профиль для публикации в ComfyHub",
	...
	"next": "Далее",
	"publishButton": "Опубликовать в ComfyHub",
	...
	"title": "Публикация в ComfyHub",
	"unsavedDescription": "Вы должны сохранить свой рабочий процесс перед публикацией в ComfyHub. Сохраните его сейчас, чтобы продолжить.",
...
var errorOverlay = {
	...
	"showMissingMedia": "Показать отсутствующие входные данные",
	"showMissingModels": "Показать отсутствующие модели",
	"showMissingNodes": "Показать отсутствующие узлы",
...
var shareWorkflow = {
	...
	"comfyHubButton": "Загрузить в ComfyHub",
	"comfyHubDescription": "ComfyHub — это официальный хаб сообщества ComfyUI.\nВаш рабочий процесс получит публичную страницу, доступную для всех.",
	"comfyHubTitle": "Загрузить в ComfyHub",
	"copyLink": "Копировать",
...
//#endregion
export { actionbar, apiNodesCostBreakdown, apiNodesSignInDialog, appBuilder, assetBrowser, auth, batch, billingOperation, boundingBox, breadcrumbsMenu, builderFooter, builderMenu, builderSave, builderToolbar, clipboard, cloudFooter_needHelp, cloudForgotPassword_backToLogin, cloudForgotPassword_didntReceiveEmail, cloudForgotPassword_emailLabel, cloudForgotPassword_emailPlaceholder, cloudForgotPassword_emailRequired, cloudForgotPassword_instructions, cloudForgotPassword_passwordResetError, cloudForgotPassword_passwordResetSent, cloudForgotPassword_sendResetLink, cloudForgotPassword_title, cloudNotification, cloudOnboarding, cloudPrivateBeta_desc, cloudPrivateBeta_title, cloudSorryContactSupport_title, cloudStart_desc, cloudStart_download, cloudStart_explain, cloudStart_learnAboutButton, cloudStart_title, cloudStart_wantToRun, cloudSurvey_steps_familiarity, cloudSurvey_steps_industry, cloudSurvey_steps_making, cloudSurvey_steps_purpose, cloudWaitlist_contactLink, cloudWaitlist_questionsText, color, comfyHubProfile, comfyHubPublish, commands, contextMenu, credits, curveWidget, dataTypes, main_default as default, desktopDialogs, desktopMenu, desktopStart, desktopUpdate, downloadGit, electronFileDownload, errorDialog, errorOverlay, essentials, execution, exportToast, g, graphCanvasMenu, groupNode, help, helpCenter, icon, imageCompare, imageCrop, importFailed, install, issueReport, linearMode, load3d, loadWorkflowWarning, maintenance, manager, maskEditor, mediaAsset, menu, menuLabels, minimap, missingModelsDialog, missingNodes, nightly, nightlySurvey, nodeCategories, nodeErrors, nodeFilters, nodeHelpPage, nodeReplacement, nodeTemplates, notSupported, openSharedWorkflow, painter, progressToast, queue, releaseToast, rightSidePanel, secrets, selectionToolbox, serverConfig, serverConfigCategories, serverConfigItems, serverStart, settingsCategories, shape, shareNoOutputs, shareWorkflow, shortcuts, sideToolbar, subgraphStore, subscription, tabMenu, teamWorkspacesDialog, templateWidgets, templateWorkflows, templates, toastMessages, userSelect, userSettings, validation, versionMismatchWarning, vueNodesBanner, vueNodesMigration, vueNodesMigrationMainMenu, vueNodesSlot, welcome, whatsNewPopup, widgetFileUpload, widgets, workflowService, workspace, workspaceAuth, workspacePanel, workspaceSwitcher, zoomControls };

//# sourceMappingURL=main-CV7ooEGp.js.map