...
import { ak as captureException, al as consoleSandbox, am as logger, an as startInactiveSpan, ao as getActiveSpan, ap as timestampInSeconds, aq as SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN, ar as defineIntegration, as as hasTracingEnabled, at as GLOBAL_OBJ, au as SDK_VERSION, av as getDefaultIntegrations, aw as init$1, ax as onIdTokenChanged, ay as getApp, az as initializeAuth, aA as browserPopupRedirectResolver, aB as indexedDBLocalPersistence, aC as browserLocalPersistence, aD as browserSessionPersistence } from "./vendor-other-Bfb5Ofrh.js";
import { effectScope, ref, markRaw, toRaw, isRef, isReactive, toRef, hasInjectionContext, inject, watch, reactive, getCurrentScope, onScopeDispose, nextTick, toRefs, computed, getCurrentInstance, shallowRef, unref, shallowReactive, defineComponent, h, provide } from "vue";
...
const repeat = /* @__PURE__ */ __name((str, n) => {
  return str.repeat(n);
}, "repeat");
const formatComponentName = /* @__PURE__ */ __name((vm, includeFile) => {
  if (!vm) {
...
const generateComponentTrace = /* @__PURE__ */ __name((vm) => {
...
const attachErrorHandler = /* @__PURE__ */ __name((app, options) => {
...
const vueInit = /* @__PURE__ */ __name((app, options) => {
  if (DEBUG_BUILD) {
...
__name(useFirebaseApp, "useFirebaseApp");
...
__name(_getCurrentUserState, "_getCurrentUserState");
...
__name(setupOnAuthStateChanged, "setupOnAuthStateChanged");
...
__name(VueFireAuth, "VueFireAuth");
...
__name(VueFireAuthWithDependencies, "VueFireAuthWithDependencies");
...
__name(_VueFireAuthInit, "_VueFireAuthInit");
function useFirebaseAuth(name) {
  return isClient ? inject(_VueFireAuthKey) : null;
}
__name(useFirebaseAuth, "useFirebaseAuth");
...
export {
  ...
  init as i,
  storeToRefs as s,
  useFirebaseAuth as u
};
//# sourceMappingURL=vendor-vue-SdQKVoRx.js.map
