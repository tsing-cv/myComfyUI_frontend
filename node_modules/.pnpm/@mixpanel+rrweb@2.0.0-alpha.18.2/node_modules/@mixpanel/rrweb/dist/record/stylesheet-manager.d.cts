import { serializedNodeWithId, adoptedStyleSheetCallback, mutationCallBack } from '../../../types';
...
export declare class StylesheetManager {
    ...
    adoptStyleSheets(sheets: CSSStyleSheet[] | readonly CSSStyleSheet[], hostId: number): void;
    reset(): void;
