import { Mirror, MaskInputOptions, SlimDOMOptions, MaskInputFn, MaskTextFn } from '../../rrweb-snapshot';
import { IframeManager } from './record/iframe-manager';
import { ShadowDomManager } from './record/shadow-dom-manager';
import { Replayer } from './replay';
import { RRNode } from '../../rrdom';
import { CanvasManager } from './record/observers/canvas/canvas-manager';
import { StylesheetManager } from './record/stylesheet-manager';
import { DataURLOptions, addedNodeMutation, blockClass, canvasMutationCallback, customElementCallback, eventWithTime, fontCallback, hooksParam, inputCallback, IWindow, KeepIframeSrcFn, listenerHandler, maskTextClass, mediaInteractionCallback, mouseInteractionCallBack, mousemoveCallBack, mutationCallBack, RecordPlugin, SamplingStrategy, scrollCallback, selectionCallback, styleDeclarationCallback, styleSheetRuleCallback, viewportResizeCallback, PackFn, UnpackFn } from '../../types';
import { default as ProcessedNodeManager } from './record/processed-node-manager';
