...
import {
  compile
} from "./chunk-I7I2SGDC.js";
import "./chunk-JFX2XDYW.js";
import "./chunk-WOE2UERD.js";
import {
  __commonJS,
  __toESM
} from "./chunk-RIL2R2WR.js";
...
async function mdxPlugin(options) {
  let filter = createFilter(/\.mdx$/), { presets } = options, mdxPluginOptions = (await presets.apply("options", {}))?.mdxPluginOptions, rehypeSlug = (await import("./rehype-slug-4SZJIPPS.js")).default, rehypeExternalLinks = (await import("./rehype-external-links-4JMGEN2G.js")).default;
  return {
