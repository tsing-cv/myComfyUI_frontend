import { hasESNodeParentExtension, isESArrowFunctionExpression, isESCallExpression, isESFunctionExpression, isESNode, isESSimpleStringLiteral, isESVariableDeclarator } from "../parsers/es.js";
...
function findMatchingNestedNodes(node, matcherFunctions, deadEnd = value => isESNode(value) && (isESCallExpression(value) || isESArrowFunctionExpression(value) || isESVariableDeclarator(value) || isESFunctionExpression(value))) {
