...
const isArrayExpression = _typescript_eslint_utils.ASTUtils.isNodeOfType(_typescript_eslint_utils.AST_NODE_TYPES.ArrayExpression);
const isArrowFunctionExpression = _typescript_eslint_utils.ASTUtils.isNodeOfType(_typescript_eslint_utils.AST_NODE_TYPES.ArrowFunctionExpression);
const isBlockStatement = _typescript_eslint_utils.ASTUtils.isNodeOfType(_typescript_eslint_utils.AST_NODE_TYPES.BlockStatement);
const isCallExpression = _typescript_eslint_utils.ASTUtils.isNodeOfType(_typescript_eslint_utils.AST_NODE_TYPES.CallExpression);
const isExpressionStatement = _typescript_eslint_utils.ASTUtils.isNodeOfType(_typescript_eslint_utils.AST_NODE_TYPES.ExpressionStatement);
const isVariableDeclaration$1 = _typescript_eslint_utils.ASTUtils.isNodeOfType(_typescript_eslint_utils.AST_NODE_TYPES.VariableDeclaration);
const isAssignmentExpression = _typescript_eslint_utils.ASTUtils.isNodeOfType(_typescript_eslint_utils.AST_NODE_TYPES.AssignmentExpression);
const isChainExpression = _typescript_eslint_utils.ASTUtils.isNodeOfType(_typescript_eslint_utils.AST_NODE_TYPES.ChainExpression);
const isSequenceExpression = _typescript_eslint_utils.ASTUtils.isNodeOfType(_typescript_eslint_utils.AST_NODE_TYPES.SequenceExpression);
const isImportDeclaration = _typescript_eslint_utils.ASTUtils.isNodeOfType(_typescript_eslint_utils.AST_NODE_TYPES.ImportDeclaration);
const isImportDefaultSpecifier = _typescript_eslint_utils.ASTUtils.isNodeOfType(_typescript_eslint_utils.AST_NODE_TYPES.ImportDefaultSpecifier);
const isTSImportEqualsDeclaration = _typescript_eslint_utils.ASTUtils.isNodeOfType(_typescript_eslint_utils.AST_NODE_TYPES.TSImportEqualsDeclaration);
const isImportExpression = _typescript_eslint_utils.ASTUtils.isNodeOfType(_typescript_eslint_utils.AST_NODE_TYPES.ImportExpression);
const isImportNamespaceSpecifier = _typescript_eslint_utils.ASTUtils.isNodeOfType(_typescript_eslint_utils.AST_NODE_TYPES.ImportNamespaceSpecifier);
const isImportSpecifier = _typescript_eslint_utils.ASTUtils.isNodeOfType(_typescript_eslint_utils.AST_NODE_TYPES.ImportSpecifier);
const isJSXAttribute = _typescript_eslint_utils.ASTUtils.isNodeOfType(_typescript_eslint_utils.AST_NODE_TYPES.JSXAttribute);
const isLiteral = _typescript_eslint_utils.ASTUtils.isNodeOfType(_typescript_eslint_utils.AST_NODE_TYPES.Literal);
const isTemplateLiteral = _typescript_eslint_utils.ASTUtils.isNodeOfType(_typescript_eslint_utils.AST_NODE_TYPES.TemplateLiteral);
const isMemberExpression = _typescript_eslint_utils.ASTUtils.isNodeOfType(_typescript_eslint_utils.AST_NODE_TYPES.MemberExpression);
const isNewExpression = _typescript_eslint_utils.ASTUtils.isNodeOfType(_typescript_eslint_utils.AST_NODE_TYPES.NewExpression);
const isObjectExpression = _typescript_eslint_utils.ASTUtils.isNodeOfType(_typescript_eslint_utils.AST_NODE_TYPES.ObjectExpression);
const isObjectPattern = _typescript_eslint_utils.ASTUtils.isNodeOfType(_typescript_eslint_utils.AST_NODE_TYPES.ObjectPattern);
const isProperty = _typescript_eslint_utils.ASTUtils.isNodeOfType(_typescript_eslint_utils.AST_NODE_TYPES.Property);
const isReturnStatement = _typescript_eslint_utils.ASTUtils.isNodeOfType(_typescript_eslint_utils.AST_NODE_TYPES.ReturnStatement);
const isFunctionExpression = _typescript_eslint_utils.ASTUtils.isNodeOfType(_typescript_eslint_utils.AST_NODE_TYPES.FunctionExpression);
const isFunctionDeclaration = _typescript_eslint_utils.ASTUtils.isNodeOfType(_typescript_eslint_utils.AST_NODE_TYPES.FunctionDeclaration);
//#endregion
//#region src/node-utils/index.ts
const ValidLeftHandSideExpressions = [
	_typescript_eslint_utils.AST_NODE_TYPES.CallExpression,
	_typescript_eslint_utils.AST_NODE_TYPES.ClassExpression,
	_typescript_eslint_utils.AST_NODE_TYPES.ClassDeclaration,
	_typescript_eslint_utils.AST_NODE_TYPES.FunctionExpression,
	_typescript_eslint_utils.AST_NODE_TYPES.Literal,
	_typescript_eslint_utils.AST_NODE_TYPES.TemplateLiteral,
	_typescript_eslint_utils.AST_NODE_TYPES.MemberExpression,
	_typescript_eslint_utils.AST_NODE_TYPES.ArrayExpression,
	_typescript_eslint_utils.AST_NODE_TYPES.ArrayPattern,
	_typescript_eslint_utils.AST_NODE_TYPES.ClassExpression,
	_typescript_eslint_utils.AST_NODE_TYPES.FunctionExpression,
	_typescript_eslint_utils.AST_NODE_TYPES.Identifier,
	_typescript_eslint_utils.AST_NODE_TYPES.JSXElement,
	_typescript_eslint_utils.AST_NODE_TYPES.JSXFragment,
	_typescript_eslint_utils.AST_NODE_TYPES.JSXOpeningElement,
	_typescript_eslint_utils.AST_NODE_TYPES.MetaProperty,
	_typescript_eslint_utils.AST_NODE_TYPES.ObjectExpression,
	_typescript_eslint_utils.AST_NODE_TYPES.ObjectPattern,
	_typescript_eslint_utils.AST_NODE_TYPES.Super,
	_typescript_eslint_utils.AST_NODE_TYPES.ThisExpression,
	_typescript_eslint_utils.AST_NODE_TYPES.TSNullKeyword,
	_typescript_eslint_utils.AST_NODE_TYPES.TaggedTemplateExpression,
	_typescript_eslint_utils.AST_NODE_TYPES.TSNonNullExpression,
	_typescript_eslint_utils.AST_NODE_TYPES.TSAsExpression,
...
function findClosestVariableDeclaratorNode(node) {
	if (!node) return null;
	if (_typescript_eslint_utils.ASTUtils.isVariableDeclarator(node)) return node;
...
function findClosestCallNode(node, name) {
	if (!node.parent) return null;
	if (isCallExpression(node) && _typescript_eslint_utils.ASTUtils.isIdentifier(node.callee) && node.callee.name === name) return node;
	else return findClosestCallNode(node.parent, name);
}
function hasThenProperty(node) {
	return isMemberExpression(node) && _typescript_eslint_utils.ASTUtils.isIdentifier(node.property) && node.property.name === "then";
}
function hasPromiseHandlerProperty(node) {
	return isMemberExpression(node) && _typescript_eslint_utils.ASTUtils.isIdentifier(node.property) && [
		"then",
		"catch",
		"finally"
...
function isPromiseIdentifier(node) {
	return _typescript_eslint_utils.ASTUtils.isIdentifier(node) && node.name === "Promise";
}
function isPromiseAll(node) {
	return isMemberExpression(node.callee) && isPromiseIdentifier(node.callee.object) && _typescript_eslint_utils.ASTUtils.isIdentifier(node.callee.property) && node.callee.property.name === "all";
}
function isPromiseAllSettled(node) {
	return isMemberExpression(node.callee) && isPromiseIdentifier(node.callee.object) && _typescript_eslint_utils.ASTUtils.isIdentifier(node.callee.property) && node.callee.property.name === "allSettled";
}
/**
...
function isPromiseHandled(nodeIdentifier) {
	...
	return [nodeIdentifier, closestCallExpressionNode == null ? null : getRootExpression(closestCallExpressionNode)].filter((node) => node != null).some((node) => {
		...
		if (_typescript_eslint_utils.ASTUtils.isAwaitExpression(node.parent)) return true;
...
function getRootExpression(expression) {
	...
	switch (parent.type) {
		case _typescript_eslint_utils.AST_NODE_TYPES.ConditionalExpression: return getRootExpression(parent);
		case _typescript_eslint_utils.AST_NODE_TYPES.LogicalExpression: {
			let rootExpression;
		...
		case _typescript_eslint_utils.AST_NODE_TYPES.SequenceExpression: return parent.expressions[parent.expressions.length - 1] === expression ? getRootExpression(parent) : expression;
		case _typescript_eslint_utils.AST_NODE_TYPES.ChainExpression: return getRootExpression(parent);
		default: return expression;
	}
}
function getVariableReferences(context, node) {
	if (_typescript_eslint_utils.ASTUtils.isVariableDeclarator(node)) return getDeclaredVariables(context, node)[0]?.references?.slice(1) ?? [];
	return [];
}
function getInnermostFunctionScope(context, asyncQueryNode) {
	const innermostScope = _typescript_eslint_utils.ASTUtils.getInnermostScope(getScope(context, asyncQueryNode), asyncQueryNode);
	if (innermostScope.type === _typescript_eslint_scope_manager.ScopeType.function && _typescript_eslint_utils.ASTUtils.isFunction(innermostScope.block)) return innermostScope;
	return null;
}
...
function getPropertyIdentifierNode(node) {
	if (_typescript_eslint_utils.ASTUtils.isIdentifier(node)) return node;
	...
	if (_typescript_eslint_utils.ASTUtils.isAwaitExpression(node)) return getPropertyIdentifierNode(node.argument);
	return null;
}
/**
...
function getDeepestIdentifierNode(node) {
	...
	if (isMemberExpression(node) && _typescript_eslint_utils.ASTUtils.isIdentifier(node.property)) return node.property;
	if (isCallExpression(node)) return getDeepestIdentifierNode(node.callee);
	if (_typescript_eslint_utils.ASTUtils.isAwaitExpression(node)) return getDeepestIdentifierNode(node.argument);
	return null;
}
/**
...
function getFunctionName(node) {
	return _typescript_eslint_utils.ASTUtils.getFunctionNameWithKind(node).match(/('\w+')/g)?.[0].replace(/'/g, "") ?? "";
}
...
function getAssertNodeInfo(node) {
	...
	if (!isCallExpression(node.object) || !_typescript_eslint_utils.ASTUtils.isIdentifier(node.object.callee)) return emptyInfo;
	if (node.object.callee.name !== "expect") return emptyInfo;
	let matcher = _typescript_eslint_utils.ASTUtils.getPropertyName(node);
	const isNegated = matcher === "not";
	if (isNegated) matcher = node.parent && isMemberExpression(node.parent) ? _typescript_eslint_utils.ASTUtils.getPropertyName(node.parent) : null;
...
function hasClosestExpectHandlesPromise(node) {
	if (isCallExpression(node) && _typescript_eslint_utils.ASTUtils.isIdentifier(node.callee) && node.parent && isMemberExpression(node.parent) && ["expect", "expectAsync"].includes(node.callee.name)) {
		const expectMatcher = node.parent.property;
		return _typescript_eslint_utils.ASTUtils.isIdentifier(expectMatcher) && matcherNamesHandlePromise.includes(expectMatcher.name);
	}
	if (!node.parent) return false;
...
function hasImportMatch(importNode, identifierName) {
	if (_typescript_eslint_utils.ASTUtils.isIdentifier(importNode)) return importNode.name === identifierName;
...
function getCallExpressionFromNode(node) {
	...
	if (_typescript_eslint_utils.ASTUtils.isAwaitExpression(node)) return getCallExpressionFromNode(node.argument);
...
function isEmptyFunction(node) {
	if (_typescript_eslint_utils.ASTUtils.isFunction(node) && isBlockStatement(node.body)) return node.body.body.length === 0;
	return false;
}
/**
...
function findImportSpecifier(specifierName, node) {
	if (isImportDeclaration(node)) {
		const namedExport = node.specifiers.find((n) => {
			return isImportSpecifier(n) && _typescript_eslint_utils.ASTUtils.isIdentifier(n.imported) && [n.imported.name, n.local.name].includes(specifierName);
		});
		if (namedExport) return namedExport;
		return node.specifiers.find((n) => isImportNamespaceSpecifier(n));
	} else {
		if (!_typescript_eslint_utils.ASTUtils.isVariableDeclarator(node.parent)) return;
		const requireNode = node.parent;
		if (_typescript_eslint_utils.ASTUtils.isIdentifier(requireNode.id)) return requireNode.id;
		if (!isObjectPattern(requireNode.id)) return;
		const property = requireNode.id.properties.find((n) => isProperty(n) && _typescript_eslint_utils.ASTUtils.isIdentifier(n.key) && n.key.name === specifierName);
		if (!property) return;
		return property.key;
	}
}
...
*/
const isIdentifier$1 = (node, name) => _typescript_eslint_utils.ASTUtils.isIdentifier(node) && (name === void 0 || node.name === name);
/**
...
const describeVariableDefAsImport = (def) => {
	...
	const sourceNode = isCallExpression(def.node.init) && isIdentifier$1(def.node.init.callee, "require") ? def.node.init.arguments[0] : _typescript_eslint_utils.ASTUtils.isAwaitExpression(def.node.init) && isImportExpression(def.node.init.argument) ? def.node.init.argument.source : null;
...
const describePossibleImportDef = (def) => {
	if (def.type === _typescript_eslint_scope_manager.DefinitionType.Variable) return describeVariableDefAsImport(def);
	if (def.type === _typescript_eslint_scope_manager.DefinitionType.ImportBinding) return describeImportDefAsImport(def);
	return null;
};
	...
	return (context, optionsWithDefault) => {
		...
		*/
		function isPotentialTestingLibraryFunction(node, isPotentialFunctionCallback) {
			...
			const originalNodeName = isImportSpecifier(importedUtilSpecifier) && _typescript_eslint_utils.ASTUtils.isIdentifier(importedUtilSpecifier.imported) && importedUtilSpecifier.local.name !== importedUtilSpecifier.imported.name ? importedUtilSpecifier.imported.name : void 0;
		...
		*/
		const isFireEventMethod = (node) => {
			...
			if (fireEventUtil) fireEventUtilName = _typescript_eslint_utils.ASTUtils.isIdentifier(fireEventUtil) ? fireEventUtil.name : fireEventUtil.local.name;
			...
			const regularCall = _typescript_eslint_utils.ASTUtils.isIdentifier(definedParentMemberExpression.object) && isCallExpression(definedParentMemberExpression.parent) && definedParentMemberExpression.object.name === fireEventUtilName && node.name !== FIRE_EVENT_NAME$1 && node.name !== fireEventUtilName;
			const wildcardCall = isMemberExpression(definedParentMemberExpression.object) && _typescript_eslint_utils.ASTUtils.isIdentifier(definedParentMemberExpression.object.object) && definedParentMemberExpression.object.object.name === fireEventUtilName && _typescript_eslint_utils.ASTUtils.isIdentifier(definedParentMemberExpression.object.property) && definedParentMemberExpression.object.property.name === FIRE_EVENT_NAME$1 && node.name !== FIRE_EVENT_NAME$1 && node.name !== fireEventUtilName;
			const wildcardCallWithCallExpression = _typescript_eslint_utils.ASTUtils.isIdentifier(definedParentMemberExpression.object) && definedParentMemberExpression.object.name === fireEventUtilName && _typescript_eslint_utils.ASTUtils.isIdentifier(definedParentMemberExpression.property) && definedParentMemberExpression.property.name === FIRE_EVENT_NAME$1 && !isMemberExpression(definedParentMemberExpression.parent) && node.name === FIRE_EVENT_NAME$1 && node.name !== fireEventUtilName;
		...
		const isUserEventMethod = (node, userEventSetupVars) => {
			...
			if (userEventName && [userEventName, USER_EVENT_NAME$2].includes(node.name) || _typescript_eslint_utils.ASTUtils.isIdentifier(parentMemberExpression.object) && parentMemberExpression.object.name === node.name) return false;
			if (userEventName && _typescript_eslint_utils.ASTUtils.isIdentifier(parentMemberExpression.object) && parentMemberExpression.object.name === userEventName) return true;
			if (userEventSetupVars && _typescript_eslint_utils.ASTUtils.isIdentifier(parentMemberExpression.object) && userEventSetupVars.has(parentMemberExpression.object.name)) return true;
			return false;
		};
		/**
		...
		*/
		...
		const isCreateEventUtil = (node) => {
			...
			if (isCallExpression(node) && isMemberExpression(node.callee) && _typescript_eslint_utils.ASTUtils.isIdentifier(node.callee.object)) return isPotentialTestingLibraryFunction(node.callee.object, isCreateEventCallback);
			if (isCallExpression(node) && isMemberExpression(node.callee) && isMemberExpression(node.callee.object) && _typescript_eslint_utils.ASTUtils.isIdentifier(node.callee.object.property)) return isPotentialTestingLibraryFunction(node.callee.object.property, isCreateEventCallback);
		...
		const isDebugUtil = (identifierNode, validNames = DEBUG_UTILS) => {
			return !(isMemberExpression(identifierNode.parent) && _typescript_eslint_utils.ASTUtils.isIdentifier(identifierNode.parent.object) && identifierNode.parent.object.name === "console") && isPotentialTestingLibraryFunction(identifierNode, (identifierNodeName, originalNodeName) => {
				return validNames.includes(identifierNodeName) || !!originalNodeName && validNames.includes(originalNodeName);
			});
		};
		/**
		...
		*/
		...
		const findImportedUserEventSpecifier = () => {
			...
			if (isImportDeclaration(importedUserEventLibraryNode)) {
				...
				if (!_typescript_eslint_utils.ASTUtils.isVariableDeclarator(importedUserEventLibraryNode.parent)) return null;
				const requireNode = importedUserEventLibraryNode.parent;
				if (!_typescript_eslint_utils.ASTUtils.isIdentifier(requireNode.id)) return null;
	...
	create(context, [options], helpers) {
		...
		return {
			VariableDeclarator(node) {
				...
				if (node.init && isUserEventSetupCall(node.init) && node.id.type === _typescript_eslint_utils.AST_NODE_TYPES.Identifier) userEventSetupVars.add(node.id.name);
				if (node.id.type === _typescript_eslint_utils.AST_NODE_TYPES.ObjectPattern && node.init && node.init.type === _typescript_eslint_utils.AST_NODE_TYPES.CallExpression && node.init.callee.type === _typescript_eslint_utils.AST_NODE_TYPES.Identifier) {
					const functionName = node.init.callee.name;
					const setupProps = setupFunctions.get(functionName);
					if (setupProps) {
						for (const prop of node.id.properties) if (prop.type === _typescript_eslint_utils.AST_NODE_TYPES.Property && prop.key.type === _typescript_eslint_utils.AST_NODE_TYPES.Identifier && setupProps.has(prop.key.name) && prop.value.type === _typescript_eslint_utils.AST_NODE_TYPES.Identifier) userEventSetupVars.add(prop.value.name);
					}
				}
			},
			ReturnStatement(node) {
				if (!isUserEventEnabled || !node.argument || node.argument.type !== _typescript_eslint_utils.AST_NODE_TYPES.ObjectExpression) return;
				const setupProps = /* @__PURE__ */ new Set();
				for (const prop of node.argument.properties) if (prop.type === _typescript_eslint_utils.AST_NODE_TYPES.Property && prop.key.type === _typescript_eslint_utils.AST_NODE_TYPES.Identifier) {
					if (isUserEventSetupCall(prop.value)) setupProps.add(prop.key.name);
					else if (prop.value.type === _typescript_eslint_utils.AST_NODE_TYPES.Identifier && userEventSetupVars.has(prop.value.name)) setupProps.add(prop.key.name);
				}
			...
			"CallExpression Identifier"(node) {
				if (isFireEventEnabled && helpers.isFireEventMethod(node) || isUserEventEnabled && helpers.isUserEventMethod(node, userEventSetupVars)) {
					...
					else for (const reference of references) if (_typescript_eslint_utils.ASTUtils.isIdentifier(reference.identifier)) reportUnhandledNode({
	...
	create(context, _, helpers) {
		...
		return { CallExpression(node) {
			...
			if (helpers.isAsyncQuery(identifierNode)) {
				...
				if (references.length === 0) {
					if (!isPromiseHandled(identifierNode)) {
						context.report({
							...
							fix: (fixer) => {
								if (isMemberExpression(identifierNode.parent) && _typescript_eslint_utils.ASTUtils.isIdentifier(identifierNode.parent.object)) return fixer.insertTextBefore(identifierNode.parent, "await ");
				...
				for (const reference of references) if (_typescript_eslint_utils.ASTUtils.isIdentifier(reference.identifier) && !isPromiseHandled(reference.identifier)) {
					context.report({
						node: identifierNode,
						messageId: "awaitAsyncQuery",
						data: { name: identifierNode.name },
	...
	create(context, _, helpers) {
		...
		function detectDestructuredAsyncUtilWrapperAliases(node) {
			for (const property of node.properties) {
				...
				if (!_typescript_eslint_utils.ASTUtils.isIdentifier(property.key) || !_typescript_eslint_utils.ASTUtils.isIdentifier(property.value)) continue;
		...
		return {
			VariableDeclarator(node) {
				...
				if (_typescript_eslint_utils.ASTUtils.isIdentifier(node.id) && node.init !== null && !isCallExpression(node.init) && !_typescript_eslint_utils.ASTUtils.isAwaitExpression(node.init) && functionWrappersNames.includes(getDeepestIdentifierNode(node.init)?.name ?? "")) functionWrappersNames.push(node.id.name);
			},
			CallExpression(node) {
	...
	create(context, [options], helpers) {
		...
		return {
			VariableDeclaration(node) {
				hasDelayDeclarationOrAssignmentGTZero = node.declarations.some((property) => _typescript_eslint_utils.ASTUtils.isIdentifier(property.id) && property.id.name === "delay" && isLiteral(property.init) && property.init.value && Number.isInteger(property.init.value) && Number(property.init.value) > 0);
			},
			AssignmentExpression(node) {
				if (_typescript_eslint_utils.ASTUtils.isIdentifier(node.left) && node.left.name === "delay" && isLiteral(node.right) && node.right.value !== null) hasDelayDeclarationOrAssignmentGTZero = Number.isInteger(node.right.value) && Number(node.right.value) > 0;
			},
			"AwaitExpression > CallExpression"(node) {
				...
				const hasDelayProperty = isObjectExpression(lastArg) && lastArg.properties.some((property) => isProperty(property) && _typescript_eslint_utils.ASTUtils.isIdentifier(property.key) && property.key.name === "delay");
				const hasDelayLiteralGTZero = isObjectExpression(lastArg) && lastArg.properties.some((property) => isProperty(property) && _typescript_eslint_utils.ASTUtils.isIdentifier(property.key) && property.key.name === "delay" && isLiteral(property.value) && !!property.value.value && Number.isInteger(property.value.value) && Number(property.value.value) > 0);
	...
	create(context, _, helpers) {
		...
		function showErrorIfChainedContainerMethod(innerNode) {
			if (isMemberExpression(innerNode)) {
				if (_typescript_eslint_utils.ASTUtils.isIdentifier(innerNode.object)) {
					...
					containerCallsMethod = _typescript_eslint_utils.ASTUtils.isIdentifier(innerNode.property) && innerNode.property.name === "container" && isRenderWrapper;
		...
		return {
			CallExpression(node) {
				...
				else if (_typescript_eslint_utils.ASTUtils.isIdentifier(node.callee) && destructuredContainerPropNames.includes(node.callee.name)) context.report({
					node,
					messageId: "noContainer"
				});
			},
			VariableDeclarator(node) {
				...
				if (isObjectPattern(node.id)) {
					const containerIndex = node.id.properties.findIndex((property) => isProperty(property) && _typescript_eslint_utils.ASTUtils.isIdentifier(property.key) && property.key.name === "container");
					const nodeValue = containerIndex !== -1 && node.id.properties[containerIndex]?.value;
					if (!nodeValue) return;
					if (_typescript_eslint_utils.ASTUtils.isIdentifier(nodeValue)) containerName = nodeValue.name;
					else if (isObjectPattern(nodeValue)) nodeValue.properties.forEach((property) => isProperty(property) && _typescript_eslint_utils.ASTUtils.isIdentifier(property.key) && destructuredContainerPropNames.push(property.key.name));
				} else if (_typescript_eslint_utils.ASTUtils.isIdentifier(node.id)) renderResultVarName = node.id.name;
			}
		};
	}
});
	...
	create(context, [{ utilsToCheckFor = {} }], helpers) {
		...
		return {
			VariableDeclarator(node) {
				...
				if (!helpers.isRenderVariableDeclarator(node) && !isRenderWrapperVariableDeclarator) return;
				if (isObjectPattern(node.id)) {
					for (const property of node.id.properties) if (isProperty(property) && _typescript_eslint_utils.ASTUtils.isIdentifier(property.key) && utilsToReport.includes(property.key.name)) {
				...
				if (_typescript_eslint_utils.ASTUtils.isIdentifier(node.id)) suspiciousReferenceNodes.push(node.id);
			},
			CallExpression(node) {
				const callExpressionIdentifier = getDeepestIdentifierNode(node);
				if (!callExpressionIdentifier) return;
		...
		*/
		...
		function hasRegexInVariable(identifier) {
			return variableNodesWithRegexs.find((varNode) => {
				if (_typescript_eslint_utils.ASTUtils.isVariableDeclarator(varNode) && _typescript_eslint_utils.ASTUtils.isIdentifier(varNode.id)) return varNode.id.name === identifier.name;
			});
		}
		return {
			VariableDeclarator(node) {
				if (_typescript_eslint_utils.ASTUtils.isVariableDeclarator(node) && isLiteral(node.init) && "regex" in node.init && node.init.regex.flags.includes("g")) variableNodesWithRegexs.push(node);
			},
			CallExpression(node) {
				const identifierNode = getDeepestIdentifierNode(node);
				...
				if (_typescript_eslint_utils.ASTUtils.isIdentifier(firstArg)) {
					const regexVariableNode = hasRegexInVariable(firstArg);
					if (regexVariableNode !== void 0) context.report({
						node: firstArg,
						messageId: "noGlobalRegExpFlagInQuery",
						fix(fixer) {
							if (_typescript_eslint_utils.ASTUtils.isVariableDeclarator(regexVariableNode) && isLiteral(regexVariableNode.init) && "regex" in regexVariableNode.init && regexVariableNode.init.regex.flags.includes("g")) {
				...
				if (isObjectExpression(secondArg)) {
					const namePropertyNode = secondArg.properties.find((p) => isProperty(p) && _typescript_eslint_utils.ASTUtils.isIdentifier(p.key) && p.key.name === "name" && isLiteral(p.value));
	...
	create(context, _, helpers) {
		function reportImportReferences(references) {
			for (const reference of references) {
				...
				if (utilsUsage && isMemberExpression(utilsUsage) && _typescript_eslint_utils.ASTUtils.isIdentifier(utilsUsage.property) && utilsUsage.property.name === "cleanup") context.report({
		...
		function reportCandidateModule(moduleNode) {
			if (isImportDeclaration(moduleNode)) {
				...
				const cleanupSpecifier = moduleNode.specifiers.find((specifier) => isImportSpecifier(specifier) && _typescript_eslint_utils.ASTUtils.isIdentifier(specifier.imported) && specifier.imported.name === "cleanup");
				...
				if (isObjectPattern(declaratorNode.id)) {
					const cleanupProperty = declaratorNode.id.properties.find((property) => isProperty(property) && _typescript_eslint_utils.ASTUtils.isIdentifier(property.key) && property.key.name === "cleanup");
...
var no_node_access_default = createTestingLibraryRule({
	...
	create(context, [{ allowContainerFirstChild = false }], helpers) {
		function showErrorForNodeAccess(node) {
			...
			const propertyName = _typescript_eslint_utils.ASTUtils.isIdentifier(node.property) ? node.property.name : null;
			if (propertyName && ALL_RETURNING_NODES.some((allReturningNode) => allReturningNode === propertyName)) {
				...
				if (_typescript_eslint_utils.ASTUtils.isIdentifier(node.object) && node.object.name === "props") return;
				context.report({
					node,
		...
		return {
			CallExpression(node) {
				...
				const { callee } = node;
				if (!EVENT_HANDLER_METHODS.some((method) => method === _typescript_eslint_utils.ASTUtils.getPropertyName(callee))) return;
...
var no_promise_in_fire_event_default = createTestingLibraryRule({
	...
	create(context, _, helpers) {
		function checkSuspiciousNode(node, originalNode) {
			if (_typescript_eslint_utils.ASTUtils.isAwaitExpression(node)) return;
			...
			if (_typescript_eslint_utils.ASTUtils.isIdentifier(node)) {
				const nodeVariable = _typescript_eslint_utils.ASTUtils.findVariable(getScope(context, node), node.name);
...
function findClosestBeforeHook(node, testingFrameworkSetupHooksToFilter) {
	...
	if (isCallExpression(node) && _typescript_eslint_utils.ASTUtils.isIdentifier(node.callee) && testingFrameworkSetupHooksToFilter.includes(node.callee.name)) return node.callee;
...
var no_unnecessary_act_default = createTestingLibraryRule({
	...
	create(context, [{ isStrict = true }], helpers) {
		...
		function getStatementIdentifier(statement) {
			...
			if (isExpressionStatement(statement) && _typescript_eslint_utils.ASTUtils.isAwaitExpression(statement.expression)) return getPropertyIdentifierNode(statement.expression.argument);
		...
		*/
		...
		function registerUserEventInstance(node) {
			...
			if (propertyIdentifier?.name === testingLibraryFn?.local && deepestIdentifier?.name === "setup" && _typescript_eslint_utils.ASTUtils.isIdentifier(node.parent?.id)) userEventInstanceNames.add(node.parent.id.name);
		}
		return {
		...
		function reportSideEffects(node) {
			...
			sideEffects.forEach((sideEffectNode) => context.report({
				...
				fix(fixer) {
					...
					const targetNode = (0, _typescript_eslint_utils_ast_utils.isAwaitExpression)(callExpressionNode.parent) ? callExpressionNode.parent : callExpressionNode;
					const lines = sourceCode.getText().split("\n");
	...
	create(context, _, helpers) {
		function getClosestAsyncUtil(node) {
			...
			do {
				...
				if (_typescript_eslint_utils.ASTUtils.isIdentifier(callExpression.callee) && helpers.isAsyncUtil(callExpression.callee)) return callExpression.callee;
				if (isMemberExpression(callExpression.callee) && _typescript_eslint_utils.ASTUtils.isIdentifier(callExpression.callee.property) && helpers.isAsyncUtil(callExpression.callee.property)) return callExpression.callee.property;
...
const isAtTopLevel = (node) => !!node.parent?.parent && node.parent.parent.type === _typescript_eslint_utils.TSESTree.AST_NODE_TYPES.ExpressionStatement || node.parent?.parent?.type === _typescript_eslint_utils.TSESTree.AST_NODE_TYPES.AwaitExpression && !!node.parent.parent.parent && node.parent.parent.parent.type === _typescript_eslint_utils.TSESTree.AST_NODE_TYPES.ExpressionStatement;
const isVariableDeclaration = (node) => {
	if (isCallExpression(node.parent) && _typescript_eslint_utils.ASTUtils.isAwaitExpression(node.parent.parent) && _typescript_eslint_utils.ASTUtils.isVariableDeclarator(node.parent.parent.parent)) return true;
	if (isCallExpression(node.parent) && _typescript_eslint_utils.ASTUtils.isVariableDeclarator(node.parent.parent)) return true;
	if (isMemberExpression(node.parent) && isCallExpression(node.parent.parent) && _typescript_eslint_utils.ASTUtils.isAwaitExpression(node.parent.parent.parent) && _typescript_eslint_utils.ASTUtils.isVariableDeclarator(node.parent.parent.parent.parent)) return true;
	if (isMemberExpression(node.parent) && isCallExpression(node.parent.parent) && _typescript_eslint_utils.ASTUtils.isVariableDeclarator(node.parent.parent.parent)) return true;
	return false;
};
			...
			"Program:exit"() {
				...
				getQueryCalls.forEach((queryCall) => {
					...
					if (assertion) {
						...
						if (!_typescript_eslint_utils.ASTUtils.isIdentifier(property)) return;
						let matcher = property.name;
						let isNegatedMatcher = false;
						if (matcher === "not" && isMemberExpression(expectStatement.parent) && _typescript_eslint_utils.ASTUtils.isIdentifier(expectStatement.parent.property)) {
...
function findRenderDefinitionDeclaration(scope, query) {
	...
	if (variable) return variable.defs.map(({ name }) => name).filter(_typescript_eslint_utils.ASTUtils.isIdentifier).find(({ name }) => name === query) ?? null;
	...
	create(context, _, helpers) {
		...
		*/
		...
		function getWrongQueryNameInAssertion(node) {
			...
			if (isCallExpression(node.body.callee.object) && isCallExpression(node.body.callee.object.arguments[0]) && _typescript_eslint_utils.ASTUtils.isIdentifier(node.body.callee.object.arguments[0].callee)) return node.body.callee.object.arguments[0].callee;
			if (!_typescript_eslint_utils.ASTUtils.isIdentifier(node.body.callee.property)) return null;
			if (isCallExpression(node.body.callee.object) && isCallExpression(node.body.callee.object.arguments[0]) && isMemberExpression(node.body.callee.object.arguments[0].callee) && _typescript_eslint_utils.ASTUtils.isIdentifier(node.body.callee.object.arguments[0].callee.property)) return node.body.callee.object.arguments[0].callee.property;
			if (isMemberExpression(node.body.callee.object) && isCallExpression(node.body.callee.object.object) && isCallExpression(node.body.callee.object.object.arguments[0]) && isMemberExpression(node.body.callee.object.object.arguments[0].callee) && _typescript_eslint_utils.ASTUtils.isIdentifier(node.body.callee.object.object.arguments[0].callee.property)) return node.body.callee.object.object.arguments[0].callee.property;
			if (isMemberExpression(node.body.callee.object) && isCallExpression(node.body.callee.object.object) && isCallExpression(node.body.callee.object.object.arguments[0]) && _typescript_eslint_utils.ASTUtils.isIdentifier(node.body.callee.object.object.arguments[0].callee)) return node.body.callee.object.object.arguments[0].callee;
			return node.body.callee.property;
		}
		function getWrongQueryName(node) {
			if (!isCallExpression(node.body)) return null;
			if (_typescript_eslint_utils.ASTUtils.isIdentifier(node.body.callee) && helpers.isSyncQuery(node.body.callee)) return node.body.callee;
			return getWrongQueryNameInAssertion(node);
		}
		function getCaller(node) {
			if (!isCallExpression(node.body) || !isMemberExpression(node.body.callee)) return null;
			if (_typescript_eslint_utils.ASTUtils.isIdentifier(node.body.callee.object)) return node.body.callee.object.name;
			if (isCallExpression(node.body.callee.object) && _typescript_eslint_utils.ASTUtils.isIdentifier(node.body.callee.object.callee) && isCallExpression(node.body.callee.object.arguments[0]) && isMemberExpression(node.body.callee.object.arguments[0].callee) && _typescript_eslint_utils.ASTUtils.isIdentifier(node.body.callee.object.arguments[0].callee.object)) return node.body.callee.object.arguments[0].callee.object.name;
		...
		function isScreenSyncQuery(node) {
			...
			if (!isMemberExpression(node.body.callee) || !_typescript_eslint_utils.ASTUtils.isIdentifier(node.body.callee.property)) return false;
			if (!_typescript_eslint_utils.ASTUtils.isIdentifier(node.body.callee.object) && !isCallExpression(node.body.callee.object) && !isMemberExpression(node.body.callee.object)) return false;
		...
		return { "AwaitExpression > CallExpression"(node) {
			if (!_typescript_eslint_utils.ASTUtils.isIdentifier(node.callee) || !helpers.isAsyncUtil(node.callee, ["waitFor"])) return;
			...
			if (isBlockStatement(argument.body) && argument.async) {
				...
				const findByDeclarator = (body.filter(isVariableDeclaration$1)?.flatMap((declaration) => declaration.declarations)).find((declaration) => {
					if (!_typescript_eslint_utils.ASTUtils.isAwaitExpression(declaration.init) || !isCallExpression(declaration.init.argument)) return false;
				...
				const init = _typescript_eslint_utils.ASTUtils.isAwaitExpression(findByDeclarator?.init) ? findByDeclarator.init.argument : null;
			...
			if (isScreenSyncQuery(argument)) {
				...
				reportInvalidUsage(node, {
					...
					fix(fixer) {
						...
						if (_typescript_eslint_utils.ASTUtils.isVariableDeclarator(node.parent.parent)) {
							if ((0, _typescript_eslint_utils_ast_utils.isIdentifier)(property) && helpers.isCustomQuery(property)) return null;
			...
			reportInvalidUsage(node, {
				...
				fix(fixer) {
					...
					if (definition.parent && isObjectPattern(definition.parent.parent)) {
						...
						if (allVariableDeclarations.properties.some((p) => isProperty(p) && _typescript_eslint_utils.ASTUtils.isIdentifier(p.key) && p.key.name === findByMethod)) return allFixes;
...
const isCalledUsingSomeObject = (node) => isMemberExpression(node.parent) && node.parent.object.type === _typescript_eslint_utils.AST_NODE_TYPES.Identifier;
const isCalledInExpect = (node, isAsyncQuery) => {
	if (isAsyncQuery) return isCallExpression(node.parent) && _typescript_eslint_utils.ASTUtils.isAwaitExpression(node.parent.parent) && isCallExpression(node.parent.parent.parent) && _typescript_eslint_utils.ASTUtils.isIdentifier(node.parent.parent.parent.callee) && node.parent.parent.parent.callee.name === "expect";
	return isCallExpression(node.parent) && isCallExpression(node.parent.parent) && _typescript_eslint_utils.ASTUtils.isIdentifier(node.parent.parent.callee) && node.parent.parent.callee.name === "expect";
};
				...
				findQueryCalls.forEach((queryCall) => {
					...
					if (node) {
						if (isCalledInExpect(node, isAsyncQuery)) {
							if (isMemberExpression(node.parent?.parent?.parent?.parent) && node.parent?.parent?.parent?.parent.property.type === _typescript_eslint_utils.AST_NODE_TYPES.Identifier && helpers.isPresenceAssert(node.parent.parent.parent.parent)) return reportError(context, node, "findBy*");
						}
					}
				});
				getQueryCalls.forEach((queryCall) => {
					...
					if (node) {
						if (isCalledInExpect(node, isAsyncQuery)) {
							if (isMemberExpression(node.parent?.parent?.parent) && node.parent?.parent?.parent.property.type === _typescript_eslint_utils.AST_NODE_TYPES.Identifier && helpers.isPresenceAssert(node.parent.parent.parent)) return reportError(context, node, "getBy*");
						}
					}
				});
			}
...
function usesContainerOrBaseElement(node) {
	...
	return isObjectExpression(secondArgument) && secondArgument.properties.some((property) => isProperty(property) && _typescript_eslint_utils.ASTUtils.isIdentifier(property.key) && ALLOWED_RENDER_PROPERTIES_FOR_DESTRUCTURING.includes(property.key.name));
}
var prefer_screen_queries_default = createTestingLibraryRule({
	...
	create(context, _, helpers) {
		...
		function saveSafeDestructuredQueries(node) {
			if (isObjectPattern(node.id)) {
				for (const property of node.id.properties) if (isProperty(property) && _typescript_eslint_utils.ASTUtils.isIdentifier(property.key) && helpers.isBuiltInQuery(property.key)) safeDestructuredQueries.push(property.key.name);
			}
		}
		...
		return {
			VariableDeclarator(node) {
				if (!isCallExpression(node.init) || !_typescript_eslint_utils.ASTUtils.isIdentifier(node.init.callee)) return;
				...
				else if (_typescript_eslint_utils.ASTUtils.isIdentifier(node.id)) withinDeclaredVariables.push(node.id.name);
			},
			CallExpression(node) {
				const identifierNode = getDeepestIdentifierNode(node);
				if (!identifierNode) return;
				...
				if (isCallExpression(memberExpressionNode.object) && _typescript_eslint_utils.ASTUtils.isIdentifier(memberExpressionNode.object.callee) && memberExpressionNode.object.callee.name !== "within" && isReportableRender(memberExpressionNode.object.callee) && !usesContainerOrBaseElement(memberExpressionNode.object)) {
					reportInvalidUsage(identifierNode);
					return;
				}
				const testingLibraryFn = resolveToTestingLibraryFn(node, context);
				if (_typescript_eslint_utils.ASTUtils.isIdentifier(memberExpressionNode.object) && !isIdentifierAllowed(memberExpressionNode.object.name) && !isIdentifierAllowed(testingLibraryFn?.original ?? "")) reportInvalidUsage(identifierNode);
			}
		};
	}
});
...
var prefer_user_event_default = createTestingLibraryRule({
	...
	create(context, [options], helpers) {
		...
		const getFireEventMethodName = (callExpressionNode, node) => {
			if (!_typescript_eslint_utils.ASTUtils.isIdentifier(callExpressionNode.callee) && !isMemberExpression(callExpressionNode.callee)) return node.name;
			const secondArgument = callExpressionNode.arguments[1];
			if (_typescript_eslint_utils.ASTUtils.isIdentifier(secondArgument) && createEventVariables[secondArgument.name] !== void 0) return createEventVariables[secondArgument.name];
			if (!isCallExpression(secondArgument) || !helpers.isCreateEventUtil(secondArgument)) return node.name;
			if (_typescript_eslint_utils.ASTUtils.isIdentifier(secondArgument.callee)) return secondArgument.arguments[0].value;
		...
		return {
			...
			VariableDeclarator(node) {
				if (!isCallExpression(node.init) || !helpers.isCreateEventUtil(node.init) || !_typescript_eslint_utils.ASTUtils.isIdentifier(node.id)) return;
				let fireEventMethodName = "";
				if (isMemberExpression(node.init.callee) && _typescript_eslint_utils.ASTUtils.isIdentifier(node.init.callee.property)) fireEventMethodName = node.init.callee.property.name;
...
var prefer_user_event_setup_default = createTestingLibraryRule({
	...
	create(context, options, helpers) {
		...
		function isUserEventSetupCall(node) {
			return node.type === _typescript_eslint_utils.AST_NODE_TYPES.CallExpression && node.callee.type === _typescript_eslint_utils.AST_NODE_TYPES.MemberExpression && node.callee.object.type === _typescript_eslint_utils.AST_NODE_TYPES.Identifier && node.callee.object.name === userEventIdentifier && node.callee.property.type === _typescript_eslint_utils.AST_NODE_TYPES.Identifier && node.callee.property.name === SETUP_METHOD_NAME;
		}
		return {
			ImportDeclaration(node) {
				if (node.source.value === USER_EVENT_PACKAGE) {
					const defaultImport = node.specifiers.find((spec) => spec.type === _typescript_eslint_utils.AST_NODE_TYPES.ImportDefaultSpecifier);
					if (defaultImport) userEventIdentifier = defaultImport.local.name;
					const namedImport = node.specifiers.find((spec) => spec.type === _typescript_eslint_utils.AST_NODE_TYPES.ImportSpecifier && spec.imported.type === _typescript_eslint_utils.AST_NODE_TYPES.Identifier && spec.imported.name === USER_EVENT_NAME);
					if (namedImport && namedImport.type === _typescript_eslint_utils.AST_NODE_TYPES.ImportSpecifier) userEventIdentifier = namedImport.local.name;
				}
			},
			VariableDeclarator(node) {
				if (!userEventIdentifier || !node.init) return;
				if (isUserEventSetupCall(node.init) && node.id.type === _typescript_eslint_utils.AST_NODE_TYPES.Identifier) userEventSetupVars.add(node.id.name);
				if (node.id.type === _typescript_eslint_utils.AST_NODE_TYPES.ObjectPattern && node.init.type === _typescript_eslint_utils.AST_NODE_TYPES.CallExpression && node.init.callee.type === _typescript_eslint_utils.AST_NODE_TYPES.Identifier) {
					const functionName = node.init.callee.name;
					const setupProps = setupFunctions.get(functionName);
					if (setupProps) {
						for (const prop of node.id.properties) if (prop.type === _typescript_eslint_utils.AST_NODE_TYPES.Property && prop.key.type === _typescript_eslint_utils.AST_NODE_TYPES.Identifier && setupProps.has(prop.key.name) && prop.value.type === _typescript_eslint_utils.AST_NODE_TYPES.Identifier) userEventSetupVars.add(prop.value.name);
			...
			FunctionDeclaration(node) {
				...
				if (node.body && node.body.type === _typescript_eslint_utils.AST_NODE_TYPES.BlockStatement) {
					for (const statement of node.body.body) if (statement.type === _typescript_eslint_utils.AST_NODE_TYPES.ReturnStatement) {
						const ret = statement;
						if (ret.argument && ret.argument.type === _typescript_eslint_utils.AST_NODE_TYPES.ObjectExpression) {
							const props = /* @__PURE__ */ new Set();
							for (const prop of ret.argument.properties) if (prop.type === _typescript_eslint_utils.AST_NODE_TYPES.Property && prop.key.type === _typescript_eslint_utils.AST_NODE_TYPES.Identifier && prop.value && isUserEventSetupCall(prop.value)) props.add(prop.key.name);
			...
			CallExpression(node) {
				...
				if (node.callee.type === _typescript_eslint_utils.AST_NODE_TYPES.MemberExpression && node.callee.property.type === _typescript_eslint_utils.AST_NODE_TYPES.Identifier && helpers.isUserEventMethod(node.callee.property)) {
					const methodName = node.callee.property.name;
					if (methodName === SETUP_METHOD_NAME) return;
					if (!(node.callee.object.type === _typescript_eslint_utils.AST_NODE_TYPES.Identifier && userEventSetupVars.has(node.callee.object.name))) context.report({
						node: node.callee,
	...
	create(context, _, helpers) {
		...
		return {
			...
			VariableDeclarator(node) {
				...
				const renderResultName = _typescript_eslint_utils.ASTUtils.isIdentifier(node.id) && node.id.name;
...
//#endregion
//#region src/index.ts
const { name: packageName, version: packageVersion } = (0, node_module.createRequire)(require("url").pathToFileURL(__filename).href)((0, node_path.resolve)((0, node_path.dirname)((0, node_url.fileURLToPath)(require("url").pathToFileURL(__filename).href)), "../package.json"));
...
//#endregion
module.exports = testingLibraryPlugin;
