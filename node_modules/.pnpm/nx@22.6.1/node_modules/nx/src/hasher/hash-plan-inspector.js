...
class HashPlanInspector {
    ...
    async init() {
        ...
        this.inspector = new native_1.HashPlanInspector(externalReferences.allWorkspaceFiles, this.projectGraphRef, externalReferences.projectFiles, this.workspaceRootPath);
    }
    /**
