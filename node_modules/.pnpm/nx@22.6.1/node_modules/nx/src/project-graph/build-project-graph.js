...
async function updateProjectGraphWithPlugins(context, initProjectGraph, plugins, sourceMap) {
    ...
    spinner = new delayed_spinner_1.DelayedSpinner(`Creating project graph dependencies with ${createDependencyPlugins.length} plugins`);
...
async function applyProjectMetadata(graph, plugins, context, sourceMap) {
    ...
    spinner = new delayed_spinner_1.DelayedSpinner(`Creating project metadata with ${createMetadataPlugins.length} plugins`);
