...
class ProjectNameInNodePropsManager {
    constructor() {
        ...
        // not matter.
        this.projectNameSubstitutors = new Map();
        ...
        for (const ownerRoot in pluginResultProjects) {
            ...
            for (const targetName in project.targets) {
                ...
                if (Array.isArray(targetConfig.dependsOn)) {
                    this.registerSubstitutorsForDependsOn(ownerRoot, targetName, targetConfig.dependsOn);
                }
            }
        }
    }
    ...
    registerSubstitutorsForDependsOn(ownerRoot, targetName, dependsOn) {
        ...
        for (let i = 0; i < dependsOn.length; i++) {
            ...
            if (typeof dep === 'string') {
                ...
                if (!dep.startsWith('^')) {
                    const [maybeProject, ...rest] = (0, split_target_1.splitTargetFromNodes)(dep, this.knownProjectNodes);
                    if (rest.length > 0) {
