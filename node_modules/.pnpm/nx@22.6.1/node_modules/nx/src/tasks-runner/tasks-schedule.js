...
class TasksSchedule {
    ...
    async processTaskForBatches(batches, task, rootExecutorName, isRoot, visitedInBatch) {
        ...
        const { batchImplementationFactory, preferBatch } = (0, utils_1.getExecutorForTask)(task, this.projectGraph);
        ...
        const batchForced = this.options.batch === true || process.env.NX_BATCH_MODE === 'true';
