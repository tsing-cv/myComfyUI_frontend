import { Properties, RageclickConfig, SessionIdChangedCallback, DeadClicksAutoCaptureConfig, SupportedWebVitalsMetrics, CaptureResult, SurveyRenderReason, ToolbarParams, PostHog as PostHog$1, PostHogConfig as PostHogConfig$1, PerformanceCaptureConfig, SessionRecordingCanvasOptions, InitiatorType, CapturedNetworkRequest, SessionRecordingOptions, EventName, JsonType, FeatureFlagDetail, RequestResponse, SeverityLevel, FeatureFlagsCallback, FeatureFlagOptions, FeatureFlagResult, RemoteConfigFeatureFlagCallback, OverrideFeatureFlagsOptions, EarlyAccessFeatureCallback, EarlyAccessFeatureStage, RequestQueueConfig, RequestCallback, CaptureOptions, Property, ExceptionAutoCaptureConfig } from '@posthog/types';
 ...
 */
type TreeShakeable<T> = 'optional' extends keyof TreeShakeableConfig ? T | undefined : T;
...
declare module 'posthog-js/dist/module.slim.no-external' {
    interface TreeShakeableConfig {
        optional: true;
    }
}
