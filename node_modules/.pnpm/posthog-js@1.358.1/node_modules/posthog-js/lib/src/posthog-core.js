...
var PostHog = /** @class */ (function () {
    ...
    PostHog.prototype._initExtensions = function (startInCookielessMode) {
        ...
        if (ext.conversations) {
            this._extensions.push((this.conversations = (_d = this.conversations) !== null && _d !== void 0 ? _d : new ext.conversations(this)));
        }
        if (ext.productTours) {
        ...
        if (ext.toolbar) {
            this._extensions.push((this.toolbar = (_e = this.toolbar) !== null && _e !== void 0 ? _e : new ext.toolbar(this)));
        }
        if (ext.experiments) {
            this._extensions.push((this.experiments = (_f = this.experiments) !== null && _f !== void 0 ? _f : new ext.experiments(this)));
        }
    ...
    PostHog.prototype.reset = function (reset_device_id) {
        ...
        (_e = this.persistence) === null || _e === void 0 ? void 0 : _e.set_property(constants_1.USER_STATE, 'anonymous');
        (_f = this.sessionManager) === null || _f === void 0 ? void 0 : _f.resetSessionId();
        this._cachedPersonProperties = null;
        if (this.config.cookieless_mode === 'always') {
            this.register_once({
                distinct_id: constants_1.COOKIELESS_SENTINEL_VALUE,
