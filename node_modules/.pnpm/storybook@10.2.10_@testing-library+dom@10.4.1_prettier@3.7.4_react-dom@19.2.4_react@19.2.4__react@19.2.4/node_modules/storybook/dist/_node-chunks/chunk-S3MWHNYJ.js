...
var getComponentVariableName = async (name) => (await import("./camelcase-N45JY6VQ.js")).default(name.replace(/^[^a-zA-Z_$]*/, ""), { pascalCase: !0 }).replace(/[^a-zA-Z_$]+/, "");
