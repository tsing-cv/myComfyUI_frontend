...
import {
  toEstree
} from "../_node-chunks/chunk-2I2JGMTD.js";
import {
  StatusTypeIdMismatchError
} from "../_node-chunks/chunk-JJ4WZFTM.js";
import {
  debounce,
  generateStoryFile,
  getErrorLevel,
  ...
  useStatics,
  withTelemetry
} from "../_node-chunks/chunk-S3MWHNYJ.js";
import {
  detectPnp
} from "../_node-chunks/chunk-3KEDMJED.js";
import "../_node-chunks/chunk-Y43GVOCV.js";
import {
  StorybookError
} from "../_node-chunks/chunk-XVQKHFDF.js";
import {
  telemetry
} from "../_node-chunks/chunk-WB5YPQHK.js";
import "../_node-chunks/chunk-KKJGRNT2.js";
import {
...
import "../_node-chunks/chunk-N7FT7XDI.js";
import "../_node-chunks/chunk-BJOFNAYZ.js";
import {
  require_pretty_hrtime
} from "../_node-chunks/chunk-7ZPQ47DO.js";
import "../_node-chunks/chunk-DYOEOYMX.js";
import "../_node-chunks/chunk-4DEQJ5BD.js";
import {
  invariant,
  up2 as up
} from "../_node-chunks/chunk-4UFHENG3.js";
import "../_node-chunks/chunk-6MWOZKB3.js";
import {
  importModule,
  resolvePackageDir
...
import {
  ...
  relative,
  resolve
} from "../_node-chunks/chunk-2URQAYLB.js";
import {
  slash
} from "../_node-chunks/chunk-I3QOCA6B.js";
import "../_node-chunks/chunk-MVCDD3MB.js";
import {
  Tag
} from "../_node-chunks/chunk-3GE4RMQP.js";
import {
  require_dist
} from "../_node-chunks/chunk-YZ2RCSYV.js";
import {
  require_lib,
  require_src
} from "../_node-chunks/chunk-QJX5X3RR.js";
import {
  require_picocolors
} from "../_node-chunks/chunk-5UK6GTMO.js";
import {
  __commonJS,
  __require,
  __toESM
} from "../_node-chunks/chunk-EAKWJQGP.js";
...
async function getManagerBuilder() {
  return await import("../_node-chunks/builder-manager-ZPFNTEO4.js");
}
  ...
  async function onChangeOrRemove(absolutePath, removed) {
    ...
    !removed && isDirectory(absolutePath) && await Promise.all(
      specifiers.filter((specifier) => importPath.startsWith(specifier.directory)).map(async (specifier) => {
        ...
        ), { globby } = await import("../_node-chunks/globby-YIGI4OG5.js");
...
var getAttr = (elt, what) => elt.attributes.find((n) => n.type === "JSXAttribute" && n.name.name === what), getAttrValue = (elt, what) => getAttr(elt, what)?.value, getAttrLiteral = (elt, what) => {
  ...
  let store = {
    ...
    metaTags: void 0,
    imports: void 0
  }, { compile } = await import("../_node-chunks/mdx-N42X6CFJ-5A4ZF6QJ.js");
  await compile(code, {
...
var makeAbsolute = (otherImport, normalizedPath, workingDir) => otherImport.startsWith(".") ? slash(resolve3(workingDir, normalizeStoryPath(join5(dirname2(normalizedPath), otherImport)))) : otherImport, StoryIndexGenerator = class _StoryIndexGenerator {
  ...
  static async findMatchingFiles(specifier, workingDir, ignoreWarnings = !1) {
    ...
    if (cached)
      return cached;
    let pathToSubIndex = {}, globCwd = slash(resolve3(workingDir, specifier.directory)), globPattern = specifier.files.startsWith("!") ? `./${specifier.files}` : specifier.files, { globby } = await import("../_node-chunks/globby-YIGI4OG5.js"), files = await globby(globPattern, {
      absolute: !0,
      cwd: globCwd,
